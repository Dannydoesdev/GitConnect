...
-- USERS
INSERT INTO users (githubID,email,userType,profiletype,firstName,lastName,photo,aboutmetitle,aboutme,mobile,portfoliolink)
VALUES (8306841,'jsharman@hotmail.com.au',1,1,'Jericho','Sharman','https://avatars.githubusercontent.com/u/8306841?v=4','Full Stack Software Developer','yadda yadda More stuff goes here','0478816306','www.jerichosharman.com.au');
INSERT INTO users (githubID,email,userType,profiletype,firstName,lastName,photo,aboutmetitle,aboutme,mobile,portfoliolink) 

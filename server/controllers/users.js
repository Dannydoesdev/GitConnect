        ...
        if (result.data) {
          ...
          db.query(
            `INSERT INTO ${USERS_TABLE_NAME} 
                  (githubName,userType,profiletype,email,firstName,githubuserurl,gitHubAvatar,gitHubrepos_url,gitHubFullName,gitHubCompany,gitHubBlog,gitHubTwitter,gitHubHirable,gitHubLocation,gitHubBio,gitHubMemberSince) 
